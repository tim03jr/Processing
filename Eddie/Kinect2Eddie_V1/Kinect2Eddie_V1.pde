//An attempt to connect the kinect to Robo-Ralph

//I'm pretty much copying and documenting the example called User.



//TO DO:
//When skeleton is tracked, send a character to Robo-Ralph(Will be in auto-mode). 
...
import SimpleOpenNI.*;
SimpleOpenNI kinect;        //Can name out object whatever we want.
                            //We are giving a name to out object
...
PVector com = new PVector();   //Center of Mass. This is a vector for storing vectors for moving objects. Position, Velocity, Acceleration.                               
PVector com2d = new PVector(); 

void setup()
{
  size(640*2, 480);//I'd like this to fill the whole screen.
